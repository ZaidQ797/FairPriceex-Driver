...
import {View, ViewPropTypes, TouchableOpacity, Linking} from 'react-native';
...
function InfoUser(props) {
  ...
  const linkGoogleMap = `https://www.google.com/maps/dir/${join(
    split(data[1].address, ' '),
    '+',
  )}/${join(split(data[0].address, ' '), '+')}?hl=en`;
      ...
      <View style={styles.header}>
        <Text
          ...
          h4Style={[
            ...
            visitCurrent === 'customer' &&
              styles.selectHeader(colors.secondary),
          ]}
