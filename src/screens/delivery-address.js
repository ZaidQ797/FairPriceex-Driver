...
import {white, black} from '../configs/colors';
  ...
  routes: [
    {
      ...
      legs: [
        {
          ...
          end_address:
            '2 Khuất Duy Tiến, Thanh Xuân Trung, Thanh Xuân, Hà Nội, Vietnam',
          end_location: {
            lat: 20.9923397,
            lng: 105.80308,
          },
          start_address:
            '18 Ngõ 63 Vũ Trọng Phụng, Thanh Xuân Trung, Thanh Xuân, Hà Nội, Vietnam',
          start_location: {
            lat: 20.9980261,
            lng: 105.8078549,
          },
          steps: [
            {
              ...
              html_instructions:
                'Head <b>north</b> on <b>Ngõ 57 Vũ Trọng Phụng</b> toward <b>Vũ Trọng Phụng</b><div style="font-size:0.9em">Restricted usage road</div><div style="font-size:0.9em">Pass by Công Ty Tnhh Ddn Vina (on the right)</div>',
              polyline: {
            ...
            },
            {
              ...
              html_instructions:
                'Turn <b>right</b> at Công Ty Cổ Phần đầu Tư Phát Triển Công Nghệ Sơn Việt - Ếc onto <b>Vũ Trọng Phụng</b><div style="font-size:0.9em">Pass by Nam Long Law Firm, Ltd. (on the right)</div>',
              maneuver: 'turn-right',
              polyline: {
            ...
            },
            {
              ...
              html_instructions:
                'Turn <b>right</b> at Công Ty Tnhh Một Thành Viên Sản Xuất Giấy Minh Châu onto <b>Nguyễn Trãi</b>/<wbr/><b>QL6</b><div style="font-size:0.9em">Pass by Trung Tam Tri Lieu Dong Y Vinh An Duong (on the right)</div>',
              maneuver: 'turn-right',
              polyline: {
                points:
                  's{c_CuaydSVb@BDx@vAV`@h@|@RZTb@|@~AbAbBDHV\\v@lArAtBx@nA?F?FBHDFHPP^~F`JNV?@NTR^',
              },
              start_location: {
                lat: 20.9965819,
                lng: 105.8103547,
            ...
            },
            {
              ...
              html_instructions:
                'Slight <b>right</b> at Bếp Nam ANh - chuyên thiết bị nhà bếp và phòng tắm',
            ...
            },
            {
              ...
              html_instructions:
                'Turn <b>right</b> at Phòng khám BlueStar-Ngôi Sao Xanh<div style="font-size:0.9em">Destination will be on the left</div>',
              maneuver: 'turn-right',
              polyline: {
      ...
      overview_polyline: {
        points:
          'udd_CarxdSGDGAgAwBy@gAf@]j@[x@e@jAaA^SfBgApAy@Vb@|@|A`A~AjDbGhDjFx@nA?FBPNXP^~F`JNXb@t@Dz@Ej@Mh@GNSOGK',
      },
